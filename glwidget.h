...
class GLWidget : public QOpenGLWidget, protected QOpenGLFunctions_3_3_Core {
 ...
 public:
  ...
  void GenerateIrradianceAndPrefilteredMaps(const int cubemap_width, const int cubemap_height, const int mip_levels);
